...
public class DoctorProfileController {
    ...
    public void pendingAppointmentsButtonOA(ActionEvent actionEvent) throws IOException{
        Node node = FXMLLoader.load(getClass().getResource("/Poran/pendingAppointmentsView.fxml"));
    ...
    public void cancelAppointmentButtonOA(ActionEvent actionEvent) throws IOException{
        Node node = FXMLLoader.load(getClass().getResource("/Poran/cancelAppointmentView.fxml"));
        anchorPaneForPartialWindows.getChildren().setAll(node);
    }

    @javafx.fxml.FXML
    public void rescheduleAppointmentButtonOA(ActionEvent actionEvent) throws IOException{
        Node node = FXMLLoader.load(getClass().getResource("/Poran/rescheduleAppointmentView.fxml"));
        anchorPaneForPartialWindows.getChildren().setAll(node);
    }

    @javafx.fxml.FXML
    public void appointmentHistoryButtonOA(ActionEvent actionEvent) throws IOException {
        Node node = FXMLLoader.load(getClass().getResource("/Poran/appointmentHistoryView.fxml"));
        anchorPaneForPartialWindows.getChildren().setAll(node);
    }

    @javafx.fxml.FXML
    public void patientsSeenButtonOA(ActionEvent actionEvent) throws IOException{
        Node node = FXMLLoader.load(getClass().getResource("/Poran/patientsSeenView.fxml"));
        anchorPaneForPartialWindows.getChildren().setAll(node);
    }

    @javafx.fxml.FXML
    public void startAnAppointmentButtonOA(ActionEvent actionEvent) throws IOException{
        Node node = FXMLLoader.load(getClass().getResource("/Poran/startAppointmentView.fxml"));
        anchorPaneForPartialWindows.getChildren().setAll(node);
    }

    @javafx.fxml.FXML
    public void labReportsButtonOA(ActionEvent actionEvent) throws IOException{
        Node node = FXMLLoader.load(getClass().getResource("/Poran/labReportsView.fxml"));
        anchorPaneForPartialWindows.getChildren().setAll(node);
    }

    @javafx.fxml.FXML
    public void dashBoardButtonOA(ActionEvent actionEvent) throws IOException{
        Node node = FXMLLoader.load(getClass().getResource("/Poran/DoctordashBoardView.fxml"));
        anchorPaneForPartialWindows.getChildren().setAll(node);
    }
}